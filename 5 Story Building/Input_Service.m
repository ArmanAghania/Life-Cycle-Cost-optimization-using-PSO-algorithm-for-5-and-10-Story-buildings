...
WF = Gamma*(Ls*(4*(CSection(XpsoC(1,is),5) + CSection(XpsoC(2,is),5) + CSection(XpsoC(4,is),5) + CSection(XpsoC(5,is),5)) + 2*(CSection(XpsoC(3,is),5) + CSection(XpsoC(6,is),5)))) + Gamma*Lb*(3*(BSection(XpsoB(1,is),1) + BSection(XpsoB(2,is),1) + BSection(XpsoB(3,is),1) + BSection(XpsoB(4,is),1) + BSection(XpsoB(5,is),1)));
